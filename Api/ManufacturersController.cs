...
namespace CarManufacturersAPI.Api
{
    ...
    public class ManufacturersController : ControllerBase
    {
        ...
        // GET http://localhost:5217/api/manufacturer
        [HttpGet]
        ...
        // GET http://localhost:5217/api/manufacturer/{id}
        [HttpGet("{id:int}")]
        ...
        // POST http://localhost:5217/api/manufacturer
        [HttpPost]
        ...
        // PATCH http://localhost:5217/api/manufacturer/{id}
        [HttpPatch("{id:int}")]
        ...
        // DELETE http://localhost:5217/api/manufacturer/{id}
        [HttpDelete("{id:int}")]
